      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-gray-100">
        ...
        {product.comingSoon && (
          <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center gap-1">
            ...
            <span className="rounded-full bg-amber-400 px-3 py-1 text-xs font-bold text-gray-900 tracking-wide uppercase">
              Coming Soon
            </span>
          </div>
        )}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <Button
            ...
            className={`h-9 flex-shrink-0 text-white ${
              product.comingSoon
                ? 'bg-amber-400 hover:bg-amber-400 cursor-not-allowed text-gray-900'
                : 'bg-green-600 hover:bg-green-700'
            }`}
            aria-label={product.comingSoon ? 'Coming soon' : t('product.addLabel', product.name)}
          >
            {product.comingSoon ? (
